                    ...
                    <tr >
                        <td >
                            ...
                            <form action=""  value = "dddd" method="POST" name="regForm" onsubmit="return checkForm() " >
                                <table  style="line-height: 4" width="750px" height="400px" cellpadding="0px" cellspacing="0px" >
                                    <tr  >
                                        <td colspan="2" >
                                            <font size="4" style ="margin-left: 20px;">用户信息</font> &nbsp;&nbsp;&nbsp;USER INFORMATION
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="t">
                                        ...
                                        <td  > 
                                                <input type="text" value ="${userHidden.cardno}" readonly name = "cardno" readonly style="border: none;">	
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <input type="text" value ="${userHidden.username}" readonly   name = "username"style="border: none;">	
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <input type="text" value ="${userHidden.tele}" readonly    name = "tele" style="border: none;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" value ="${userHidden.address}" readonly   name = "address" style="border: none;">					
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" value ="${userHidden.sex}" readonly  name = "sex" readonly style="border: none;">	
                                        </td>
                                    </tr>
                                    ...
                                    <tr >
                                        ...
                                        <td style="border: none;padding:20px 500px;">
                                            <input type="button" class="btn btn-default btn1" value="修改信息" id="modify" onclick="location.href='informationModify'" >
                                        </td>
                                    </tr>
